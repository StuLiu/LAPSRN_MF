...
try:
	mode_str = sys.argv[1].split("=")[1]    # NMC or others
	area_str = sys.argv[2].split("=")[1]    # 1, 2, 3, 4, 5, 6, 7, 8
	factor_str = sys.argv[3].split("=")[1]  # PRE10m, PRS, RHU, TEM, WINDAvg2mi, WINSAvg2mi
except Exception:
...
try:
	...
	flags.DEFINE_string('dem_path', dem_path, 'directory of dem')
